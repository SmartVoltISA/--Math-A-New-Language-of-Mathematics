...
def make_record(status="COUNTEREXAMPLE"):
    return ResearchRecord(
        study_id="E0-demo",
        hypothesis_id="H-SIGN-PLUS",
        null_id="H0-SIGN-UNSPECIFIED",
        model={"path": ["A", "B", "C"], "relations": [1, -1]},
        intervention={"type": "none"},
        observation={"operator": "SIGN", "value": -1},
        metric={"name": "sign", "value": -1},
        criterion={"expected": 1},
        horizon=1,
        seed=0,
        source_version="0.9.0",
        status=status,
        result={"expected": 1, "observed": -1},
    )
